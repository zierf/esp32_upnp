...
pub fn create_client() -> anyhow::Result<Client<EspHttpConnection>> {
...
pub fn get_request(client: &mut Client<EspHttpConnection>) -> anyhow::Result<()> {
...
pub fn post_request(client: &mut Client<EspHttpConnection>) -> anyhow::Result<()> {
    // Prepare payload
